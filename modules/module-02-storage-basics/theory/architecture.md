...
|--------|------|------------|------------------|---------------------|------------|
| CSV | 10 GB | 2 min | 45 sec | 45 sec | $0.23 |
| CSV + Gzip | 2.5 GB | 8 min | 60 sec | 60 sec | $0.06 |
| Parquet | 3.5 GB | 5 min | 10 sec | 3 sec | $0.08 |
| **Parquet + Snappy** | **1.4 GB** | **6 min** | **8 sec** | **2 sec** | **$0.03** ✅ |
| Parquet + Gzip | 900 MB | 15 min | 25 sec | 8 sec | $0.02 |
