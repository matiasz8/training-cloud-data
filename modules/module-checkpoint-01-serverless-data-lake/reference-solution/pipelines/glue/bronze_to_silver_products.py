...
from pyspark.sql.functions import (
    col, current_timestamp, lit, count, trim, upper, 
...
def read_bronze_products(
    ...
    try:
        ...
        logger.info(
            f"Successfully read Bronze product data",
            row_count=row_count,
        ...
        logger.error(f"Failed to read Bronze product data", exception=e)
        raise
...
def write_silver_products(
    ...
    try:
        ...
        logger.error(f"Failed to write Silver product data", exception=e)
        raise
