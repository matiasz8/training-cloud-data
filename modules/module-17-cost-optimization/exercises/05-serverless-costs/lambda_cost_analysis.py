...
def main():
    ...
    print(f"   1. Right-size memory (test 128MB to 3008MB)")
    print(f"   2. Reduce execution time (optimize code)")
    print(f"   3. Use ARM (Graviton2) for 20% discount")
    print(f"   4. Avoid Provisioned Concurrency unless required")
    print(f"   5. Set appropriate timeouts (don't pay for hangs)")
    
    print(f"\n📊 When to Choose Lambda:")
    print(f"   ✅ < 300 hours/month total runtime")
    print(f"   ✅ Sporadic or event-driven workloads")
    print(f"   ✅ Need automatic scaling")
    print(f"   ✅ Want zero infrastructure management")
    
    print(f"\n📊 When to Choose EC2:")
    print(f"   ✅ > 300 hours/month total runtime")
    print(f"   ✅ Steady 24/7 workloads")
    print(f"   ✅ Need persistent connections")
    print(f"   ✅ Can leverage Reserved Instances/Savings Plans")
