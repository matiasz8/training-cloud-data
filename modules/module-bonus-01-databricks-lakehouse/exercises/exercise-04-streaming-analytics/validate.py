...
def validate_task2_silver_transformations(spark):
    ...
    try:
        ...
        if invalid_coords == 0:
            print(f"✅ No invalid coordinates in Silver (data quality enforced)")
            score += 5
        else:
        ...
        try:
            ...
            print(f"❌ Quarantine table not found")
...
def validate_task6_monitoring(spark):
    ...
    try:
        ...
        if recent > 0:
            ...
            print(f"⚠️  No recent metrics (run for longer)")
